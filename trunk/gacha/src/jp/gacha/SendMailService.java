...
public class SendMailService extends HttpServlet {
    ...
    public static void sendMail(Map<String, String> content) throws IOException, AddressException, MessagingException {
        ...
        String subject = bundle.getString("mail.subject") + "-" + content.get("soushin");
        ...
        msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to1, to1));
        msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to2, to2));
